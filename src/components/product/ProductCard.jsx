      ...
      <div className="modal" style={{ maxWidth: 600, width: "95%" }}>
        <div className="modal-header">
          <div>
            ...
            <p className="text-muted" style={{ fontSize: "var(--fs-13)", marginTop: 2 }}>
        ...
        <div className="modal-body">
          {submitted ? (
            <div style={{ textAlign: "center", padding: "var(--space-6) 0" }}>
              ...
              <p className="text-body-sm">Added to cart. Redirecting to checkout...</p>
            </div>
          ) : (
            <form
            ...
            >
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "var(--space-4)" }}>
                <div className="form-group">
                  ...
                  <input 
                    ...
                    onChange={(e) => setForm(f => ({ ...f, picCount: parseInt(e.target.value) }))} 
                  />
              ...
              <div className="form-group">
                ...
                <textarea className="form-input form-textarea" rows={2} required placeholder="Tell us more about your ideas..." value={form.vision} onChange={(e) => setForm(f => ({ ...f, vision: e.target.value }))} />
              </div>
...
export default function ProductCard({ product }) {
  ...
  if (isService) {
    ...
    return (
      <>
        {showModal && <ServiceIdeaModal onClose={() => setShowModal(false)} serviceTitle={title} product={product} />}
        <article className="product-card" aria-label={title}>
          ...
          <div className="product-card-body">
            ...
            <h3 className="product-card-title" style={{ color: "var(--text-dark)" }}>{title}</h3>
            {artisan && (
              <p className="product-card-meta" style={{ marginBottom: "var(--space-2)" }}>
                by <span className="text-dark" style={{ fontWeight: 500 }}>{artisan}</span>
              </p>
            )}
            <div className="product-card-metadata-row" style={{ height: 100 }}>
                ...
                <div style={{ marginTop: "var(--space-1)" }}>
                    ...
                    style={{
                        background:
                        material === "Brass" ? "rgba(200,164,58,0.15)" :
                            material === "Bronze" ? "rgba(160,82,45,0.15)" :
                            "rgba(143,163,177,0.18)",
                    color:
                      material === "Brass" ? "#8a6a00" :
                        material === "Bronze" ? "#7a3415" :
                          "#4a6070",
                ...
                <p className="product-card-description-fixed" style={{ marginTop: 4 }}>
                {description}
                </p>
            </div>
            ...
            <div className="product-card-price-row">
              <span style={{ fontWeight: 700, color: "var(--primary)", fontSize: "var(--fs-15)" }}>
                Price on Request
              </span>
            </div>
          </div>
  ...
  return (
    <article className="product-card" aria-label={title}>
      <div className="product-card-image-wrap">
        <Link href={`/product/${slug}`} aria-label={`View ${title}`} tabIndex={-1}>
          {firstImage && (
            <Image
              src={firstImage}
              alt={title}
        ...
        <div className="product-card-badge">
          ...
          {stock < 10 && stock > 0 && (
            <span className="badge badge-warning" style={{ marginTop: 4, display: "block" }}>
              Low Stock
            </span>
          )}
          {stock === 0 && (
      ...
      <div className="product-card-body">
        ...
        <div className="product-card-price-row">
          ...
          {salePrice && <span className="price-sale">{formatPrice(price)}</span>}
      ...
      <div className="product-card-footer">
        <div className="flex-between">
          <div className="product-card-rating" aria-label={`Rating: ${rating} out of 5`}>
            ...
            <div>
              <span style={{ fontSize: "var(--fs-13)", color: "var(--text-medium)", fontWeight: 500 }}>
                {rating}
              </span>
