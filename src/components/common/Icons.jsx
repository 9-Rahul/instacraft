...
/**
 * A centralized repository for professional SVG icons.
 * All icons inherit currentColor and can be sized via props.
 */
...
export const LeafIcon = ({ size = 20, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M2 22s8-4 12-4 8 4 8 4V2s-8 4-12 4-8-4-8-4v20z" />
    <path d="M12 18V6" />
  </svg>
);
...
export const CoinsIcon = ({ size = 20, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <circle cx="8" cy="8" r="6" /><path d="M18.09 10.37A6 6 0 1 1 10.34 18" />
    <path d="M7 6h1v4" /><path d="M17 12h1v4" />
  </svg>
);
...
export const PinterestIcon = ({ size = 20, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M21 11a9 9 0 0 1-9 9 9.1 9.1 0 0 1-5-1.5 5.5 5.5 0 0 0 1-4.5c0 0-1-2.5-.5-5 1-4 6-5 6-1 0 3-1.5 4-3 4-1 0-1.5-1-1.5-2 0-3 3-4.5 5-4.5 4 0 5 4.5 4 8 0 5-3.5 8.5-8 8.5" />
    <path d="M12 21A9 9 0 1 1 21 12" />
  </svg>
);
...
export const PotteryIcon = ({ size = 20, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M7 4h10M8 4c0 3 1.5 6 1.5 6S5 12 5 17c0 3 3 5 7 5s7-2 7-5c0-5-4.5-7-4.5-7S16 7 16 4" />
  </svg>
);

export const PaletteIcon = ({ size = 20, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
// ── Utility / Accent Icons ──

/** Replaces ✨ sparkle emoji */
...
/** Replaces 🙏 pray / thank-you emoji */
export const PrayIcon = ({ size = 20, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
    ...
    <path d="M10 10.5V8a2 2 0 0 0-2-2 2 2 0 0 0-2 2v6a6 6 0 0 0 12 0v-3a2 2 0 0 0-2-2 2 2 0 0 0-2 2" />
  </svg>
);

/** Replaces 📱 mobile / phone emoji */
...
/** Replaces 🗿 / personalized sculpture icon */
export const SculptureIcon = ({ size = 20, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
...
/** Replaces 🕉️ / om / deity icon */
export const OmIcon = ({ size = 20, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
...
/** Replaces 📐 ruler / size icon */
export const RulerIcon = ({ size = 20, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
